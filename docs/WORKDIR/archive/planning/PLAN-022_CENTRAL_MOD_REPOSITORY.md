> Retired on 2026-09-05. The owner deleted the catalog service. This is historical context, not an implementation plan. Do not recreate its service or endpoints. Future mod distribution requires a separate design.
