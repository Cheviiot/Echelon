...
namespace GeneralsArsenalArchivePolicy
{
...
// GeneralsArsenal @feature Codex 13/08/2026 Skip only exact archive basenames selected by the trusted launcher host.
inline bool IsArchiveDisabled(const char *path)
{
	const char *policy = ::getenv("GENERALS_ARSENAL_DISABLED_BIG_FILES");
