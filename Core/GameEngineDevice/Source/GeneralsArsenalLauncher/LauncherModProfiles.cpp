...
constexpr size_t kMaximumAddons = GENERALS_ARSENAL_MAX_CONTENT_LAYERS - 2;
	...
	ModificationSelectionProfileV1 &profile, std::string &warning)
{
	...
	// GeneralsArsenal @bugfix Codex 15/08/2026 Rebuild saved stacks progressively so conflicts and exact requirements cannot survive restart.
...
// GeneralsArsenal @bugfix Codex 15/08/2026 Preserve base-mod add-ons across patch changes and remove only incompatible layers.
