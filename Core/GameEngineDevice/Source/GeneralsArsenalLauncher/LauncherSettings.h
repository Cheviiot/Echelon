...
// GeneralsArsenal @feature Codex 13/08/2026 Keep launcher and per-engine options in a versioned, testable model.
...
// GeneralsArsenal @feature Codex 13/08/2026 Persist the launcher's own display mode independently from either game.
