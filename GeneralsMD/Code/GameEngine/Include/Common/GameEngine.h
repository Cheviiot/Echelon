...
// Echelon @feature Codex 13/08/2026 Verify that a launcher session released every engine-owned singleton.
extern Bool EchelonAreEngineSubsystemSingletonsReleased();
