...
struct RepositoryModification
{
	...
	std::string sha256;
	uint64_t size = 0;
	// Echelon @feature Codex 15/08/2026 Allow catalog entries to build content from user-owned retail data.
	std::string generator;
	// Echelon @feature Codex 15/08/2026 Install author-hosted multi-file releases without repackaging them.
