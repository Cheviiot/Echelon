...
elseif(APPLE AND SAGE_USE_MOLTENVK)
  ...
  if(SAGE_DXVK_USE_LOCAL_FORK AND EXISTS "${DXVK_LOCAL_FORK_DIR}/.git")
    ...
    set(DXVK_SOURCE_DIR "${GENERALSX_BINARY_DIR}/_deps/dxvk-src-fbraz3")
    message(STATUS "DXVK macOS build: using GitHub source clone at ${DXVK_SOURCE_DIR}")
  endif()
  set(DXVK_BUILD_DIR  "${GENERALSX_BINARY_DIR}/_deps/dxvk-build-macos")
  ...
  add_custom_command(
    OUTPUT  "${GENERALSX_BINARY_DIR}/libdxvk_d3d9.0.dylib"
            "${GENERALSX_BINARY_DIR}/libdxvk_d3d8.0.dylib"
    COMMAND ${CMAKE_COMMAND} -E copy_if_different
              ${DXVK_D3D9_LIB} "${GENERALSX_BINARY_DIR}/libdxvk_d3d9.0.dylib"
    COMMAND ${CMAKE_COMMAND} -E create_symlink
              libdxvk_d3d9.0.dylib "${GENERALSX_BINARY_DIR}/libdxvk_d3d9.dylib"
    COMMAND ${CMAKE_COMMAND} -E copy_if_different
              ${DXVK_D3D8_LIB} "${GENERALSX_BINARY_DIR}/libdxvk_d3d8.0.dylib"
    COMMAND ${CMAKE_COMMAND} -E create_symlink
              libdxvk_d3d8.0.dylib "${GENERALSX_BINARY_DIR}/libdxvk_d3d8.dylib"
  ...
  add_custom_target(dxvk_d3d8_install ALL
    DEPENDS "${GENERALSX_BINARY_DIR}/libdxvk_d3d8.0.dylib"
            "${GENERALSX_BINARY_DIR}/libdxvk_d3d9.0.dylib"
  )
