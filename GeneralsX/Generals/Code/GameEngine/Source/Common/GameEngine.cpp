...
Bool EchelonAreEngineSubsystemSingletonsReleased()
{
	return TheSubsystemList == nullptr && TheMapCache == nullptr && TheSkirmishGameInfo == nullptr &&
		...
		TheGameLODManager == nullptr && TheLocalFileSystem == nullptr && TheArchiveFileSystem == nullptr &&
		TheWritableGlobalData == nullptr && TheGameText == nullptr && TheScienceStore == nullptr &&
		TheMultiplayerSettings == nullptr && TheTerrainTypes == nullptr && TheTerrainRoads == nullptr &&
		TheGlobalLanguageData == nullptr && TheAudio == nullptr && TheFunctionLexicon == nullptr &&
		TheModuleFactory == nullptr && TheMessageStream == nullptr && TheSidesList == nullptr && TheCaveSystem == nullptr &&
		TheRankInfoStore == nullptr && ThePlayerTemplateStore == nullptr && TheParticleSystemManager == nullptr &&
		TheFXListStore == nullptr && TheWeaponStore == nullptr && TheObjectCreationListStore == nullptr &&
		TheLocomotorStore == nullptr && TheSpecialPowerStore == nullptr && TheDamageFXStore == nullptr &&
		TheArmorStore == nullptr && TheBuildAssistant == nullptr && TheThingFactory == nullptr && TheUpgradeCenter == nullptr &&
		TheGameClient == nullptr && TheAI == nullptr && TheGameLogic == nullptr && TheTeamFactory == nullptr &&
		TheCrateSystem == nullptr && ThePlayerList == nullptr && TheRecorder == nullptr && TheRadar == nullptr &&
		TheVictoryConditions == nullptr && TheMetaMap == nullptr && TheActionManager == nullptr &&
