...
static void ensureScreenshotDir(char* outPath, size_t outPathLen) {
    ...
    // Echelon @tweak Codex 12/08/2026 Store screenshots under the active public product name.
    snprintf(outPath, outPathLen, "%s/Pictures/Echelon", home);
    mkdir(outPath, 0755);
}
...
static void timestampFilename(char* out, size_t outLen, const char* dir) {
    ...
    snprintf(out, outLen, "%s/echelon_%04d-%02d-%02d_%02d-%02d-%02d-%03d.png",
             dir,
